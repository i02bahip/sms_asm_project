...
set CONVERT="environment\utils\ConvertPngToIndexed\Convert.exe"
...
if exist %folder%\inc\art\backgroundImage\tileMapConverted.png del %folder%\inc\art\backgroundImage\tileMapConverted.png

%CONVERT% "%folder%\inc\art\backgroundImage\tilemap.png" "%folder%\inc\art\backgroundImage\tileMapConverted.png"
if errorlevel 1 goto :fail
%BMP2TILE% "%folder%\inc\art\backgroundImage\tileMapConverted.png" -savetiles "%folder%\inc\art\tileSets\bgTileSet.inc" -savepalette "%folder%\inc\art\palettes\bgPalette.inc" -savetilemap "%folder%\inc\art\tileMaps\bgTileMap.inc" -exit
if exist %folder%\inc\art\backgroundImage\tileMapConverted.png del %folder%\inc\art\backgroundImage\tileMapConverted.png
if errorlevel 1 goto :fail
goto:done
